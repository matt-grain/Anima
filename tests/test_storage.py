...
from anima.core import Agent, Memory, MemoryKind, Project, RegionType
...
class TestMemoryStore:
    ...
    def test_save_and_get_agent(self, memory_store: MemoryStore, test_agent: Agent) -> None:
    ...
    def test_save_and_get_project(self, memory_store: MemoryStore, test_project: Project) -> None:
    ...
    def test_save_and_get_memory(self, memory_store: MemoryStore, sample_memory: Memory) -> None:
    ...
    def test_get_memories_for_agent(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
        """Test getting all memories for an agent."""
        memories = populated_store.get_memories_for_agent(agent_id=test_agent.id, project_id=test_project.id)

        assert len(memories) == 4  # All 4 test memories

    def test_get_memories_for_agent_filtered_by_kind(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
    ...
    def test_get_memories_for_agent_filtered_by_region(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
    ...
    def test_search_memories(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
        """Test searching memories by content."""
        memories = populated_store.search_memories(agent_id=test_agent.id, query="SQLite", project_id=test_project.id)

        assert len(memories) == 1
        assert "SQLite" in memories[0].content

    def test_search_memories_partial_match(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
        """Test searching with partial match."""
        memories = populated_store.search_memories(agent_id=test_agent.id, query="humor", project_id=test_project.id)

        assert len(memories) == 1
        assert "humor" in memories[0].content

    def test_search_memories_no_match(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
    ...
    def test_supersede_memory(self, memory_store: MemoryStore, sample_memory: Memory) -> None:
    ...
    def test_count_memories(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
        """Test counting memories."""
        count = populated_store.count_memories(agent_id=test_agent.id, project_id=test_project.id)

        assert count == 4

    def test_agent_memories_included_with_project(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
...
class TestMemoryStoreEdgeCases:
    ...
    def test_update_existing_agent(self, memory_store: MemoryStore, test_agent: Agent) -> None:
    ...
    def test_memory_with_special_characters(self, memory_store: MemoryStore, test_agent: Agent) -> None:
    ...
    def test_memory_with_multiline_content(self, memory_store: MemoryStore, test_agent: Agent) -> None:
  ...
  likes: humor;
    ...
    def test_get_memories_empty_store(self, memory_store: MemoryStore) -> None:
        ...
        memories = memory_store.get_memories_for_agent(agent_id="nonexistent", project_id="nonexistent")
        assert memories == []

    def test_search_memories_case_sensitive(self, populated_store: MemoryStore, test_agent: Agent, test_project: Project) -> None:
    ...
    def test_search_memories_with_wildcards_escaped(self, memory_store: MemoryStore, test_agent: Agent) -> None:
        ...
        memories = memory_store.search_memories(agent_id=test_agent.id, query="100%")
        assert len(memories) == 1
        assert "100%" in memories[0].content

        # Search for just % should NOT match everything (it's escaped)
        memories_wildcard = memory_store.search_memories(agent_id=test_agent.id, query="%")
        # Should only find memories that literally contain %
        assert len(memories_wildcard) == 1

    def test_search_memories_with_underscore_escaped(self, memory_store: MemoryStore, test_agent: Agent) -> None:
        ...
        memories = memory_store.search_memories(agent_id=test_agent.id, query="snake_case")
        # Should only match snake_case, not snakeXcase
        assert len(memories) == 1
        assert "snake_case" in memories[0].content

    def test_save_project_with_path_conflict(self, memory_store: MemoryStore) -> None:
